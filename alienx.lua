...
local Library = {
	Themes = {
		...
		Serika = {
			Main = Color3.fromRGB(133,96,153),
			Secondary = Color3.fromRGB(66,48,76),
			Tertiary = Color3.fromRGB(141,130,147),
...
function Library:change_theme(toTheme)
	...
	Library.DisplayName.Text = "alienx ontop 🥳, <font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*255) .. "," .. math.floor(c.B*255) .. ")'> <b>" .. LocalPlayer.DisplayName .. "</b> </font>"
...
function Library:object(class, properties)
	...
	function methods:tooltip(text)
		...
		local tooltipArrow = tooltipContainer:object("ImageLabel", {
			Image = "https://create.roblox.com/store/asset/18102754374/arrow",
...
function Library:create(options)
	...
	if readfile and writefile and isfile then
		if not isfile("xalien.json") then
			writefile("xalien.json", HTTPService:JSONEncode(settings))
		end
		settings = HTTPService:JSONDecode(readfile("xalien.json"))
	...
	local closeButton = core:object("ImageButton", {
		...
		Image = "https://create.roblox.com/store/asset/18102814310/Hyperrealistic-Cross",
	...
	local searchIcon = urlBar:object("ImageLabel", {
		...
		Image = "https://create.roblox.com/store/asset/18102836581/questionmark",
		BackgroundTransparency = 1
	})
	...
	local homeButtonIcon = homeButton:object("ImageLabel", {
		...
		Image = "https://create.roblox.com/store/asset/18102878352/cool-guy",
		Theme = {ImageColor3 = "StrongText"}
	})
	...
	local displayName; do
		...
		local displayName = profile:object("TextLabel", {
			RichText = true,
			Text = "alienx ontop! 🥳, <font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*255) .. "," .. math.floor(c.B*255) .. ")'> <b>" .. LocalPlayer.DisplayName .. "</b> </font>",
			TextScaled = true,
	...
	local settingsTabIcon = profile:object("ImageButton", {
		...
		AnchorPoint = Vector2.new(1, 1),
		Image = "https://create.roblox.com/store/asset/18102888177/settingspurple"
	}):tooltip("settings")
	...
	local creditsTabIcon = profile:object("ImageButton", {
		...
		AnchorPoint = Vector2.new(1, 1),
		Image = "https://create.roblox.com/store/asset/18102918254/settings"
	}):tooltip("credits")
	...
	local creditsTab = Library.tab(mt, {
		...
		Icon = "https://create.roblox.com/store/asset/18102918254/settings"
	})
...
function Library:notification(options)
	...
	local exit = noti:object("ImageButton", {
		Image = "https://create.roblox.com/store/asset/18102932491/exitdark",
...
function Library:toggle(options)
	...
	local on = "https://create.roblox.com/store/asset/18102945576/yes"
	local off = "https://create.roblox.com/store/asset/18102954892/no"
	...
	if setclipboard then
		...
		if options.Discord then
			...
			local tr = discord:object("ImageLabel", {
				...
				ImageColor3 = Color3.fromRGB(255, 255, 255),
				Image = "https://create.roblox.com/store/asset/18102973604",
